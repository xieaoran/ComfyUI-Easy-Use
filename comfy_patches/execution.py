...
from comfy_execution.caching import (
    ...
    HierarchicalCache,
    HierarchicalDependencyAwareCache,
    LRUCache,
)
...
class CacheSet:
    ...
    def init_dependency_aware_cache(self):
        self.outputs = HierarchicalDependencyAwareCache(CacheKeySetInputSignature, "OUTPUTS")
        self.ui = HierarchicalDependencyAwareCache(CacheKeySetInputSignature, "UI")
        self.objects = HierarchicalDependencyAwareCache(CacheKeySetID, "OBJECTS")
